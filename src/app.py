...
async def start():
        ...
        [
            Select(
                ...
                items={
                     ...
                     "Meta-Llama-3-70B-Instruct": "Meta-Llama-3-70B-Instruct", 
                     "Meta-Llama-3-8B-Instruct": "Meta-Llama-3-8B-Instruct", 
                     "Meta-Llama-3.1-405B-Instruct": "Meta-Llama-3.1-405B-Instruct", "Meta-Llama-3.1-70B-Instruct": "Meta-Llama-3.1-70B-Instruct", 
                     "Meta-Llama-3.1-8B-Instruct": "Meta-Llama-3.1-8B-Instruct",
                     "Mistral-large": "Mistral-large", 
                     "Mistral-large-2407": "Mistral-large-2407", 
                     "Mistral-Nemo": "Mistral-Nemo", 
    ...
    if os.getenv("CODESPACES", "") == "true":
        Settings.llm = AzureAICompletionsModel(
            ...
            max_tokens=1024,
            streaming=True,
            model_name=github_models_names.get("Mistral-large", "Phi-3-mini-4k-instruct")
        )
        # Temporary fix for the model name issue: https://github.com/run-llama/llama_index/issues/15169#issuecomment-2299571873
        Settings.llm._model_name = github_models_names.get("Mistral-large", "Phi-3-mini-4k-instruct")
